                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>abc</td>
                                 <td>ABCD</td>
                             <td>
                                    <a href="edit-database.html" class="btn btn-success btn-circle btn-lg" data-toggle="tooltip" data-placement="left" title="Edit"><i class="fa fa-pencil-square-o fa-size"></i>
                            </a>
